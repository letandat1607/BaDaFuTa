                    ...
                    <>
                        ...
                        <>
                            ...
                            >
                                ...
                                {/* Thông tin chung */}
                                {/* <p style={{ fontSize: "13px", color: "#4b5563", margin: "2px 0" }}>📞 {item.phone}</p>
    <p style={{ fontSize: "13px", color: "#4b5563", margin: "2px 0" }}>📍 {item.delivery_address}</p>
    <p style={{ fontSize: "13px", color: "#4b5563", margin: "2px 0" }}>💳 {item.method}</p> */}
                    ...
                    >
                        {/* Nút xóa */}
                        <button
                            onClick={(e) => handleDelete(e, item, "menu_item_option")}
                            style={{
                                position: "absolute",
                                top: "20px",
                                right: "60px",
                            ...
                            onMouseEnter={(e) => (e.target.style.backgroundColor = "#7f0202")}
                            onMouseLeave={(e) => (e.target.style.backgroundColor = "#352f2f")}
                        >
                            🗑️ Hủy tất cả liên kết
                        </button>
